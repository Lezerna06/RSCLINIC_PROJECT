    ...
    <div class="main-content" >
        <div class="wrap-content container" id="container">
            ...
            <div class="container-fluid container-fullw bg-white">
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" method="POST" action="{{ route('admin.search') }}">
                            @csrf
                        ...
                        <table class="table table-hover" id="sample-table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{-- {{ route('admin.medical.history.view',$patient->id) }} --}}
                                        <a href="{{ route('admin.medical.history.view', $patient->id) }}"><i> View</i></a>            
                                    </td>
                                </tr>
                                @endforeach
                                @if(!$status)
